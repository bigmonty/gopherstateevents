...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-sm-10">
            ...
            <h3 class="h3">Finance Graphs: Year to Date Graphs</h3>

            <form class="form-inline" name="get_monthly" method="post" action="ytd.asp">
            ...
            <div class="embed-responsive embed-responsive-16by9">
				<iframe name="ytd_graph" id="ytd_graph" frameborder="0" 
					src="ytd_graph.asp?which_graph=<%=sWhichGraph%>" style="width:800px;height:400px;"></iframe>
            </div>
        </div>
	</div>
</div>
