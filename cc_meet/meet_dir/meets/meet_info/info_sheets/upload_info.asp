...
If CStr(sSent) = CStr("y") Then
	...
	sMsg = vbCrLf
	sMsg = sMsg & "The meet information sheet has been uploaded for " & sMeetName & vbCrLf & vbCrLf
...
<%
	...
	With cdoMessage
		...
		.Subject = "GSE CCMeet Info Sheet Upload"
		.TextBody = sMsg
		.Send
	End With
...
<title>GSE Upload Meet Info Sheet</title>
<!--#include file = "../../../../../includes/js.asp" -->
</head>
<body>
<div class="container">
	<h5 class="h5">Upload Meet Info Sheet</h5>
