    ...
    <div id="carousel-example-generic" class="carousel slide carousel-fade">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="item active slide1">
                <div class="row"><div class="container">
                    ...
                    <div class="col-md-9 text-left">
                        <h3 data-animation="animated bounceInDown">Welcome to Gopher State Events, LLC!</h3>
                        <h4 data-animation="animated bounceInUp">RFID Timing Company (Chip Timing Company) for road races,  </h4>             
                     </div>
                </div></div>
             </div> 
            <!-- Item 2 -->
            ...
            <div class="item slide4">
                <div class="row"><div class="container">
                    <div class="col-md-7 text-left">
                        <h3 data-animation="animated bounceInDown">Innovative!</h3>
